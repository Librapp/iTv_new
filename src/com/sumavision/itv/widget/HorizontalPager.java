...
public class HorizontalPager extends ViewGroup
{
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh)
	{
		...
		Log.i("m", String.format("currentHeight =[%d], oldHeight=[%d],current -  old=[%d]", h, oldh, Math.abs(h - oldh)));
		boolean isShown = (h < oldh);
